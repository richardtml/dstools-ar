...
Preprocessing for HMDB51 dataset.

This modules provides functions to extract spatials frames representations
of the HMDB51 dataset. Representations can be extracted using ResNet50 model,
outputs are saved at ${DATASETS}/hmdb51 directory.
...
load_config()
URL = 'https://cloud.xibalba.com.mx/s/NsAWoD92afsPYBT/download'
SPLITS_URL = 'https://cloud.xibalba.com.mx/s/tSZmzFRYa9qWSQM/download'
FILENAME = 'hmdb51-videos.tar.gz'
SPLITS_FILENAME = 'hmdb51-splits.tar.gz'
...
REPS_2048_DIR = join(DS_DIR, 'hmdb51_resnet50_2048.zarr')
REPS_1024_DIR = join(DS_DIR, 'hmdb51_resnet50_1024.zarr')
REPS_0512_DIR = join(DS_DIR, 'hmdb51_resnet50_0512.zarr')
...
def load_split(splits_dir, split, subset):
  ...
  pattern = join(splits_dir, f'*split{split}.txt')
  names = []
...
def download():
  """Downloads and extracts to ${DATASETS_DIR}/hmdb51/videos."""
...
def download_splits():
  """Downloads and extracts splits to ${DATASETS_DIR}/hmdb51/splits."""
...
def extract_reps(arch='resnet50', frames_per_batch=FRAMES_PER_BATCH):
  """Extracts representations to ${DATASETS_DIR}/hmdb51/hmdb51_resnet50_2048.zarr."""
...
def extract_splits():
  """Extracts splits to ${DATASETS_DIR}/hmdb51/splits.zarr."""
